...
Q_CONSTINIT static const qt_meta_stringdata_CLASSGameFieldENDCLASS_t qt_meta_stringdata_CLASSGameFieldENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(10, 16),  // "ChangeTextSignal"
        QT_MOC_LITERAL(27, 0),  // ""
        QT_MOC_LITERAL(28, 4),  // "text"
        QT_MOC_LITERAL(33, 13)   // "MoveSnakeSlot"
    },
    "GameField",
    "ChangeTextSignal",
    "",
...
Q_CONSTINIT const QMetaObject GameField::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSGameFieldENDCLASS_t,
        ...
        // method 'ChangeTextSignal'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<QString, std::false_type>,
        // method 'MoveSnakeSlot'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void GameField::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->ChangeTextSignal((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->MoveSnakeSlot(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &GameField::ChangeTextSignal; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
